...
def process_data():
    ...
    bucket = "airflow-project-exciess"
    emp_data_path = f"gs://{bucket}/Project-1/data/employee.csv"
    dept_data_path = f"gs://{bucket}/Project-1/data/department.csv"
    output_path = f"gs://{bucket}/Project-1/output"
